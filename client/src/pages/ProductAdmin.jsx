      ...
      <div className='p-4 bg-blue-50'>
        ...
        <div className="flex justify-center mt-4">
          <ReactPaginate
            ...
            pageClassName={'px-3 py-2 border rounded hover:bg-primary-200 cursor-pointer'}
            activeClassName={'bg-primary-200 text-white'}
            previousClassName={'px-3 py-2 border rounded hover:bg-primary-200 cursor-pointer'}
            nextClassName={'px-3 py-2 border rounded hover:bg-primary-200 cursor-pointer'}
